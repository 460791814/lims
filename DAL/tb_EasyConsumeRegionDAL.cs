...
{
    /// <summary>
    /// 数据访问类:tb_EasyConsumeRegion
    /// </summary>
    public partial class tb_EasyConsumeRegionDAL
    {
        public tb_EasyConsumeRegionDAL()
        { }
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from tb_EasyConsumeRegion");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tb_EasyConsumeRegion ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM tb_EasyConsumeRegion ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(@")AS Row, T.*  from (SELECT dbo.tb_EasyConsumeRegion.regionName,dbo.tb_EasyConsume.drugName,tb_EasyConsumeRegion.lockId, 
                                  dbo.tb_EasyConsumeRegion.id AS regionId, dbo.tb_Base.baseName as danwei, dbo.tb_EasyConsumeIN.*
                                  FROM dbo.tb_EasyConsumeIN INNER JOIN
                                  dbo.tb_EasyConsumeRegion ON dbo.tb_EasyConsumeIN.GPS = dbo.tb_EasyConsumeRegion.id INNER JOIN
                                  dbo.tb_EasyConsumeLock ON dbo.tb_EasyConsumeRegion.lockId = dbo.tb_EasyConsumeLock.id INNER JOIN
                                  dbo.tb_EasyConsume ON dbo.tb_EasyConsumeIN.drugId = dbo.tb_EasyConsume.id INNER JOIN
                                  dbo.tb_Base ON dbo.tb_EasyConsume.unit = dbo.tb_Base.id) T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "tb_EasyConsumeRegion";
        ...
        {
            string strSql = @"SELECT dbo.tb_EasyConsumeRegion.regionName, dbo.tb_EasyConsumeRegion.id AS regionId, 
                                          dbo.tb_EasyConsumeIN.*
                                          FROM dbo.tb_EasyConsumeIN INNER JOIN
                                          dbo.tb_EasyConsumeRegion ON dbo.tb_EasyConsumeIN.GPS = dbo.tb_EasyConsumeRegion.id INNER JOIN
                                          dbo.tb_EasyConsumeLock ON dbo.tb_EasyConsumeRegion.lockId = dbo.tb_EasyConsumeLock.id";
