...
namespace DAL.RoleManage
{
    ...
    /// 数据访问类:tb_Role
    /// </summary>
    public partial class D_tb_Role
    {
        public D_tb_Role()
        { }
        ...
        public int Add(E_tb_Role model)
        {
            ...
            strSql.Append("RoleName,DataRange)");
            strSql.Append(" values (");
            strSql.Append("@RoleName,@DataRange)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@RoleName", SqlDbType.NVarChar,50),
					new SqlParameter("@DataRange", SqlDbType.Int,4)};
            parameters[0].Value = model.RoleName;
            parameters[1].Value = model.DataRange;
        ...
        public bool Update(E_tb_Role model)
        {
            ...
            strSql.Append("DataRange=@DataRange");
            strSql.Append(" where RoleID=@RoleID");
            SqlParameter[] parameters = {
					new SqlParameter("@RoleName", SqlDbType.NVarChar,50),
					new SqlParameter("@DataRange", SqlDbType.Int,4),
        ...
        public E_tb_Role GetModel(int RoleID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 RoleID,RoleName,DataRange from tb_Role ");
            strSql.Append(" where RoleID=@RoleID");
            SqlParameter[] parameters = {
					new SqlParameter("@RoleID", SqlDbType.Int,4)
};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select RoleID,RoleName,DataRange ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" RoleID,RoleName,DataRange ");
            strSql.Append(" FROM tb_Role ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
